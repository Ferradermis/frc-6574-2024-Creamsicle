...
public final class Constants {
  public static final class DriveConstants {
    ...
    public static final double kMaxSpeedMetersPerSecond = 6.36; //CHANGE WHEN TESTING LIMELIGHT FOR EVERYONES SAKE MonkaS
  ...
  public static final class ModuleConstants {
    ...
    public static final double kWheelDiameterMeters = Units.inchesToMeters(2.86);
